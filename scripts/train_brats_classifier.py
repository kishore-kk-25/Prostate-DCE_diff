"""
Train a noised image classifier on brats.
"""
...
from guided_diffusion.load_brats_classifier import load_data ## changed
...
#             print(loss)
    ...
    for step in range(args.iterations - resume_step):
        ...
        try:
            forward_backward_log(data_loader)
        except:
            data_loader = iter(brats_loader)   ### added as exception error came.
            forward_backward_log(data_loader)
